...
// Shared list-based fallback used on web and inside Expo Go (where native maps can render blank).
export default function JobMapFallback({ jobs, onSelect, people = [], banner }: {
  jobs: any[]; onSelect: (j: any) => void; people?: any[]; banner: string;
}) {
  return (
